...
public class ClientUI extends JFrame {
    ...
    public ClientUI() {
        ...
        queryButton.addActionListener(e -> {
            String contact = controller.queryContact(nameField.getText());
            if (contact != null) {
                showMessage("查询成功: " + contact);
            } else {
                showMessage("未找到联系人");
            }
        });
        ...
        addComponent(inputPanel, new JLabel("电话:"), gbc, 0, 1);
        ...
        buttonPanel.add(queryButton);  // 添加查询按钮
